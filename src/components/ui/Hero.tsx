...
const Hero = ({ title = "TERANGA EDU", subtitle, imageUrl }: HeroProps = {}) => {
  return (
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="max-w-4xl mx-auto text-center stagger-animate">
          ...
          <p className="text-xl md:text-2xl mb-8 text-white">
            {subtitle || "Une solution complète de gestion numérique pour moderniser et optimiser l'administration des écoles."}
          </p>
